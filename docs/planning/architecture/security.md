...
ZIP/RAR project/design hanya mengekstrak whitelist teks/code/config dan preview image terbatas. `node_modules`, `.git`, `.env*`, `*.key`, `*.pem`, dan path traversal ditolak. Maksimum: 50 MB per file, 100 MB hasil extract, 2000 entry.
